...
syn match  amicomment1 "\/\/.*"
syn match  amicomment2 "\/\*.*\*\/"
syn region amicomment3 start=/\/\*/ end=/\*\//

hi link amicomment1 Comment
hi link amicomment2 Comment
hi link amicomment3 Comment
