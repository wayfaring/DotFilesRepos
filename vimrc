...
" Todo: use F12 to switch on/off NERDTree
...
highlight Pmenu ctermfg=darkgrey ctermbg=lightgrey guibg=darkgrey guifg=black
highlight PmenuSel ctermfg=darkgrey ctermbg=darkcyan guibg=lightgrey guifg=black
